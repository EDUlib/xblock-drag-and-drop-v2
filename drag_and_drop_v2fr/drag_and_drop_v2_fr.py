...
@XBlock.needs('i18n')
class DragAndDropFrBlock(XBlock, XBlockWithSettingsMixin, ThemableXBlockMixin):
    """
    ...
    def student_view(self, context):
        ...
        fragment.initialize_js('DragAndDropFrBlock', self.get_configuration())
    ...
    def _publish_item_dropped_event(self, attempt, is_correct):
        ...
        self.runtime.publish(self, 'edx.drag_and_drop_v2_fr.item.dropped', {
            'item': item_label,
            'item_id': item['id'],
